...
public class Main {
	...
	public static void main(String[] args) {
		...
		while (check) {
			...
			switch (secim) {
			case 1:
				televizyonKurveKanallariOlustur();
				break;
			case 2:
				televizyonuAc();
				break;
	...
	private static void kanalBilgisiniGoster() {
		if (tvAcıkMi == false) {
			...
			tv.kana3goster();
			tv.kana4goster();
			System.out.println("Şu an bulunduğunuz kanal: ");
	...
	private static void televizyonuAc() {
		...
		if (tv == null) {
			...
			if (tvAcıkMi) {
				System.out.println("Televizyonunuz açıktır.");
			} else {
	...
	public static void televizyonKurveKanallariOlustur() {
		if (tv == null) {
			Scanner scanner = new Scanner(System.in);
			...
			System.out.println("Televizyonunuz kurulmuştur!");
		}
